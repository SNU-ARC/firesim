...
class simif_t
{
  ...
  public:
     ...
     * @param theshold_bytes If pull would return less than this many bytes, it returns 0 instead. 
     * 
     * @returns Number of bytes copied. Can be less than requested.
     *
     */
    virtual size_t pull(unsigned int stream_idx, void* dest, size_t num_bytes, size_t threshold_bytes) = 0;
     ...
     * @param num_bytes Number of bytes to copy.
     * @param theshold_bytes If push would accept less than this many bytes, it accepts 0 instead. 
     * 
     * @returns Number of bytes copied. Can be less than requested.
     *
     */
    virtual size_t push(unsigned int stream_idx, void* src, size_t num_bytes, size_t threshold_bytes) = 0;
